# -*- encoding: utf-8 -*-
# stub: rubycritic 3.5.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<parser>.freeze, ["~> 2.5.0"])
      s.add_runtime_dependency(%q<rainbow>.freeze, ["~> 3.0"])
      s.add_runtime_dependency(%q<reek>.freeze, ["~> 4.4"])
      ...
      s.add_development_dependency(%q<bundler>.freeze, ["~> 1.3", ">= 1.3.0"])
      s.add_development_dependency(%q<byebug>.freeze, ["~> 9.0", ">= 8.0"])
      ...
      s.add_dependency(%q<parser>.freeze, ["~> 2.5.0"])
      s.add_dependency(%q<rainbow>.freeze, ["~> 3.0"])
      s.add_dependency(%q<reek>.freeze, ["~> 4.4"])
      ...
      s.add_dependency(%q<bundler>.freeze, ["~> 1.3", ">= 1.3.0"])
      s.add_dependency(%q<byebug>.freeze, ["~> 9.0", ">= 8.0"])
