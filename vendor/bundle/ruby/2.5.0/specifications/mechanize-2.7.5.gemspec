...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["CHANGELOG.rdoc".freeze, "EXAMPLES.rdoc".freeze, "GUIDE.rdoc".freeze, "LICENSE.rdoc".freeze, "README.rdoc".freeze]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<net-http-persistent>.freeze, [">= 2.5.2", "~> 2.5"])
      ...
      s.add_dependency(%q<net-http-persistent>.freeze, [">= 2.5.2", "~> 2.5"])
